    ...
    <div class="content-wrapper">
        ...
        <form action="../process/seller_process.php" method="post" enctype="multipart/form-data" >
            ...
            <section class="content">
                            ...
                            <div class="row w-100">
                                <div class=" ml-3" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="password" name="new_password" class="mt-2 form-control" value="<?php echo $profileData->password?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <input type="submit" class="mt-2 btn btn-success w-25 ml-3 mb-2"  name="ChangePhoto" value="Update" style="font-size: 21px;background-image: linear-gradient(#556270, #ff6b6b); text-align: center;border: 1px solid;border-radius: 25px;" >
                <div class="container-fluid">
                    <div class="row">
                        <div class="">
