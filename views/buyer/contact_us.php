                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="" class="table  table-hover">
                            <thead>
                            <tr style="color: white;background-image: linear-gradient(#5d3570, #bfa94d);position:;">
                                <th>Name</th>
                                <th>Action</th>
                            </tr>
                            </thead>
                            ...
                            <?php
                            $list = $datamanipulation->showAllAdmin();
                            $count = 1;
                            if ($list){
                                foreach ($list as $lists){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a data-id = "<?php echo $lists->admin_id?>" href="#" class="attrValue show-chat-box-click btn btn-info btn-sm"><i class="fab fa-telegram-plane"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
