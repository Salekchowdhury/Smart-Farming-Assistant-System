    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="color: #3c763d">Rating  Profile</h1>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <ul class="list-group list-group-unbordered mb-3" style="list-style: none; color: white">
                                                ...
                                                <li class="">
                                                    <b>Address:</b> <a class="float-right" style="font-style: italic;font-size: 20px"><?php echo  $userDetails->address?></a>
                                                </li>
                                            ...
                                            <b>Total Post:</b> <a class="float-right"><?php /*echo $value*/?></a>
                                                ...
                                                if(!$check){
                                                    ...
                                                    echo "<button class=\"btn btn-success d-block mx-auto\" data-toggle=\"modal\" data-target=\"#exampleModal\">Edit</button>";
