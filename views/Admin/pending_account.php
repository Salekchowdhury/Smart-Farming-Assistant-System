                        ...
                        if($lists){
                            foreach ($lists as $list){
                                ?>
                                    ...
                                    <div class="col-md-3 py-2" style="margin-left: 70px; border: 2px  royalblue; margin-top: 15px;background-image: linear-gradient(#0c0970, #4cbf15);border-radius: 20px; ">
                                        <?php
                                        if($list->image){
                                            ?>
                                        ...
                                        ?>
                                        <div class="">
                                            <a  href="../process/admin_process.php?confirmAccount=<?php echo $list->user_id?>" class="btn bg-black btn-outline-success w-100 mb-3">CONFIRM</a>
                                        </div>
                                        ...
                                        <hr>
                                        <h5 style="color: white;font-style: italic"><?php echo $list->position?></h5>
