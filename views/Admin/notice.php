            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12" style="background-color: #000b16; color: #0c525d">
                        <div class="callout callout-info" style="background-color: #000b16; color: darkgrey">
                            <?php
                                ...
                                <form action="../process/admin_process.php" method="post">
                                    <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" required class="form-control Post" name="title" rows="3" ></input>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea type="text" required class="form-control Post" name="notice" rows="5" ></textarea>
                                            </div>
                                        <div class="col-sm-12">
                                        </div>
                                    </div>
...
-->
                                    ...
                                    <div class="col-6 btn-group" style="padding-left: 290px">
                                        <a style="text-decoration: none"  href="edit_notice.php?edit_notice=<?php echo $notice->id?>" class="btn btn-success btn-sm btn-outline-dark btn-round"><i class="fa fa-eye"></i></a>
                                        <a  style="text-decoration: none" href="../process/admin_process.php?delete_notice=<?php echo $notice->id?>" class="btn btn-sm btn-outline-facebook btn-danger btn-round"><i class="fa fa-trash"></i></a>

                                    </div>

                                </div>
                                <!--<div class="mb-5 mr-5 d-flex justify-content-end">9/5/2020</div>-->
                                <div style="white-space:pre-wrap;font-size: 17px; padding-left: 13px;color: #ff2729"><?php echo $title?></div>
