                ...
                <div class="card" style="background-image: linear-gradient(#0c0970, #4cbf15)">
                    <div class="card-body">
                        <table id="rafia1" class="table table-bordered table-hover">
                            ...
                            $lists=$datamanipulation->showAllTransactionData();
                            if($lists){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if($list->status == 'yes'){
                                                ...
                                                ?>
                                                <a style="color: white" href="../process/admin_process.php?confirmPayment=<?php echo $list->id?>"title="Accept" class="btn  btn-secondary btn-outline-success bg-black"><i class="fas fa-check-circle"></i>  ACCEPT</a>
                                                <?php
                                            }
                                            ?>
